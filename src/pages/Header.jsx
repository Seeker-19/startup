...
const Header = () => {
  ...
  return (
    <div style={{ fontFamily: "Roboto Slab" }}>
      <header className="flex justify-between bg-gradient-to-br from-black via-gray-800 to-black text-white px-4 py-6 border-b-2 border-gray-700 ">
